...
if(empty($CRACHA_DATA_PEDIDO)) {
    $CRACHA_DATA_PEDIDO = "0001-01-01";
}
if(empty($CRACHA_CONTROLE)) {
    $CRACHA_CONTROLE = "0001-01-01";
}
if(empty($EMAIL_CADERNO_COMPASSO_SOLICITADO)) {
    $EMAIL_CADERNO_COMPASSO_SOLICITADO = "0001-01-01";
}
if(empty($EMAIL_CADERNO_COMPASSO_RECEBIDO)) {
    $EMAIL_CADERNO_COMPASSO_RECEBIDO = "0001-01-01";
}
if(empty($MALOTE_CADERNO_COMPASSO_CTPS)) {
    $MALOTE_CADERNO_COMPASSO_CTPS = "0001-01-01";
}
if(empty($DOCUMENTOS_RECEBIDOS_ASSINADOS)) {
    $DOCUMENTOS_RECEBIDOS_ASSINADOS = "0001-01-01";
}
if(empty($SALVAR_PASTA)) {
    $SALVAR_PASTA = "0001-01-01";
}
if(empty($CRACHA_PROTOCOLO)) {
    $CRACHA_PROTOCOLO = "0001-01-01";
}
