    ...
    <main>
                    ...
                    if ($resultado) {
                        while ($rows_dados = mysqli_fetch_assoc($resultado)) { ?>
                            ...
                            <tr style="vertical-align: right !important;">
                                ...
                                <td><a title="Proposta de Contratação" class="btn btn-default selectUser" id="selectUser" href='funcionario.php?id=<?php echo $rows_dados['USUARIO_ID']; ?>'>Ver Detalhes</a></td>
                                <td><a title="Editar" href="../alteraTelas/altera-form.php?id=<?= $rows_dados['USUARIO_ID'] ?>" type="button" class="btn btn-default">Editar</a></td>
                                <td><a title="Finalizar" href="../alteraTelas/altera-deleta.php?id=<?= $rows_dados['USUARIO_ID'] ?>" type="button" class="btn btn-default">Excluir</a></td>
                                <td></td>
                        <?php
                            }
                        } ?>
        ...
        <section class="container estruct">
            ...
            <table class='legendas-sedes'>
                ...
                <?php foreach ($listar as $linha) : ?>
                    <tr>
                        <td class='tb2'><?php echo $linha['NOME_SEDE'] ?></td>
                    </tr>
                <?php endforeach ?>
            </table>
