                ...
                <tbody>
                    <?php while ($rows_dados = mysqli_fetch_assoc($resultado)) {  ?>
                        <tr>
                            ...
                            <td <?php if ($envioprop['ENQUADRAMENTO_REMUNERACAO_ENVIO'] == "0001-01-01" or $rows_dados['ENQUADRAMENTO_REMUNERACAO_ENVIO'] == "" or "01010101") { echo ($campoV);} ?>><?php echo $rows_dados['ENQUADRAMENTO_REMUNERACAO_ENVIO']; ?></td>
                            <td <?php if ($envioprop['ENQUADRAMENTO_REMUNERACAO_RETORNO'] == "0001-01-01" or $rows_dados['ENQUADRAMENTO_REMUNERACAO_RETORNO'] == "" or "01010101") { echo ($campoV);} ?>><?php echo $rows_dados['ENQUADRAMENTO_REMUNERACAO_RETORNO']; ?></td>
                            <td <?php if ($envioprop['ENQUADRAMENTO'] == "0001-01-01" or $rows_dados['ENQUADRAMENTO'] == "" or "01010101") { echo ($campoV);} ?>><?php echo $rows_dados['ENQUADRAMENTO']; ?></td>
                            <td <?php if ($envioprop['ENVIO_PROPOSTA'] == "0001-01-01" or $rows_dados['ENVIO_PROPOSTA'] == "" or "01010101") { echo ($campoV);} ?>><?php echo $rows_dados['ENVIO_PROPOSTA']; ?></td>
                            <td <?php if ($envioprop['COMUNICAR_PROPOSTA_ENVIADA'] == "0001-01-01" or $rows_dados['COMUNICAR_PROPOSTA_ENVIADA'] == "" or "01010101") { echo ($campoV);} ?>><?php echo $rows_dados['COMUNICAR_PROPOSTA_ENVIADA']; ?></td>
                            <td <?php if ($envioprop['ACEITE_RECUSA_CANDIDATO'] == "0001-01-01" or $rows_dados['ACEITE_RECUSA_CANDIDATO'] == "" or "01010101") { echo ($campoV);} ?>><?php echo $rows_dados['ACEITE_RECUSA_CANDIDATO']; ?></td>
                            <td><?php echo $rows_dados['COMENTARIO']; ?></td>
                            <td <?php if ($envioprop['COMUNICAR_STATUS'] == "0001-01-01" or $rows_dados['COMUNICAR_STATUS'] == "" or "01010101") { echo ($campoV);} ?>><?php echo $rows_dados['COMUNICAR_STATUS']; ?></td>
