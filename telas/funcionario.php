                ...
                <tbody>
                    <?php while ($rows_dados = mysqli_fetch_assoc($resultado)) {  ?>
                        <tr>
                            ...
                            <td <?php if ($envioprop['ENQUADRAMENTO_REMUNERACAO_ENVIO'] == "01010101" or $rows_dados['ENQUADRAMENTO_REMUNERACAO_ENVIO'] == "") { echo ($campoV);} ?>><?php echo $rows_dados['ENQUADRAMENTO_REMUNERACAO_ENVIO']; ?></td>
                            <td <?php if ($envioprop['ENQUADRAMENTO_REMUNERACAO_RETORNO'] == "01010101" or $rows_dados['ENQUADRAMENTO_REMUNERACAO_RETORNO'] == "") { echo ($campoV);} ?>><?php echo $rows_dados['ENQUADRAMENTO_REMUNERACAO_RETORNO']; ?></td>
                            <td <?php if ($envioprop['ENQUADRAMENTO'] == "01010101" or $rows_dados['ENQUADRAMENTO'] == "") { echo ($campoV);} ?>><?php echo $rows_dados['ENQUADRAMENTO']; ?></td>
                            <td <?php if ($envioprop['ENVIO_PROPOSTA'] == "01010101" or $rows_dados['ENVIO_PROPOSTA'] == "") { echo ($campoV);} ?>><?php echo $rows_dados['ENVIO_PROPOSTA']; ?></td>
                            <td <?php if ($envioprop['COMUNICAR_PROPOSTA_ENVIADA'] == "01010101" or $rows_dados['COMUNICAR_PROPOSTA_ENVIADA'] == "") { echo ($campoV);} ?>><?php echo $rows_dados['COMUNICAR_PROPOSTA_ENVIADA']; ?></td>
                            <td <?php if ($envioprop['ACEITE_RECUSA_CANDIDATO'] == "01010101" or $rows_dados['ACEITE_RECUSA_CANDIDATO'] == "") { echo ($campoV);} ?>><?php echo $rows_dados['ACEITE_RECUSA_CANDIDATO']; ?></td>
                            <td><?php echo $rows_dados['COMENTARIO']; ?></td>
                            <td <?php if ($envioprop['COMUNICAR_STATUS'] == "01010101" or $rows_dados['COMUNICAR_STATUS'] == "") { echo ($campoV);} ?>><?php echo $rows_dados['COMUNICAR_STATUS']; ?></td>
