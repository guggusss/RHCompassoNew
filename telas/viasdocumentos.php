            ...
            <table id='first-table'>
                ...
                <tbody>
                    <?php while ($rows_dados = mysqli_fetch_assoc($resultado)) {  ?>
                        <tr>
                            <td><?= $status['STATUS'] ?></td>
                            <td <?php if ($malote['CRACHA_DATA_PEDIDO'] == "0001-01-01" or $rows_dados['CRACHA_DATA_PEDIDO'] == "" or "01010101") { echo ($campoV);} ?>><?php echo $rows_dados['CRACHA_DATA_PEDIDO']; ?></td>
                            <td <?php if ($malote['CRACHA_CONTROLE'] == "0001-01-01" or $rows_dados['CRACHA_CONTROLE'] == "" or "01010101") { echo ($campoV);} ?>><?php echo $rows_dados['CRACHA_CONTROLE']; ?></td>
                            <td <?php if ($malote['CRACHA_PROTOCOLO'] == "0001-01-01" or $rows_dados['CRACHA_PROTOCOLO'] == "" or "01010101") { echo ($campoV);} ?>><?php echo $rows_dados['CRACHA_PROTOCOLO']; ?></td>
                            <td <?php if ($malote['EMAIL_CADERNO_COMPASSO_SOLICITADO'] == "0001-01-01" or $rows_dados['EMAIL_CADERNO_COMPASSO_SOLICITADO'] == "" or "01010101") { echo ($campoV);} ?>><?php echo $rows_dados['EMAIL_CADERNO_COMPASSO_SOLICITADO']; ?></td>
                            <td <?php if ($malote['EMAIL_CADERNO_COMPASSO_RECEBIDO'] == "0001-01-01" or $rows_dados['EMAIL_CADERNO_COMPASSO_RECEBIDO'] == "" or "01010101") { echo ($campoV);} ?>><?php echo $rows_dados['EMAIL_CADERNO_COMPASSO_RECEBIDO']; ?></td>
                            <td <?php if ($malote['MALOTE_CADERNO_COMPASSO_CTPS'] == "0001-01-01" or $rows_dados['MALOTE_CADERNO_COMPASSO_CTPS'] == "" or "01010101") { echo ($campoV);} ?>><?php echo $rows_dados['MALOTE_CADERNO_COMPASSO_CTPS']; ?></td>
                            <td <?php if ($malote['DOCUMENTOS_RECEBIDOS_ASSINADOS'] == "0001-01-01" or $rows_dados['DOCUMENTOS_RECEBIDOS_ASSINADOS'] == "" or "01010101") { echo ($campoV);} ?>><?php echo $rows_dados['DOCUMENTOS_RECEBIDOS_ASSINADOS']; ?></td>
                            <td <?php if ($malote['SALVAR_PASTA'] == "0001-01-01" or $rows_dados['SALVAR_PASTA'] == "" or "01010101") { echo ($campoV);} ?>><?php echo $rows_dados['SALVAR_PASTA']; ?></td>
