            ...
            <table id='first-table'>
                ...
                <tbody>
                    <?php while ($rows_dados = mysqli_fetch_assoc($resultado)) {  ?>
                        <tr>
                            <td><?= $status['STATUS'] ?></td>
                            <td <?php if ($acessos['INTRANET_CADASTRO_USUARIO'] == "01010101" or $rows_dados['INTRANET_CADASTRO_USUARIO'] == "") { echo ($campoV);} ?>><?php echo $rows_dados['INTRANET_CADASTRO_USUARIO']; ?></td>
                            <td <?php if ($rows_dados['INTRANET_CADASTRO_SENHA'] == "") {
                                        echo ($campoV);
                                    } ?>><?php echo $rows_dados['INTRANET_CADASTRO_SENHA']; ?></td>
                            <td <?php if ($acessos['KAIROS_CADASTRO_USUARIO'] == "01010101" or $rows_dados['KAIROS_CADASTRO_USUARIO'] == "") { echo ($campoV);} ?>><?php echo $rows_dados['KAIROS_CADASTRO_USUARIO']; ?></td>
                            <td <?php if ($rows_dados['KAIROS_CADASTRO_SENHA'] == "") {
                                        echo ($campoV);
                                    } ?>><?php echo $rows_dados['KAIROS_CADASTRO_SENHA']; ?></td>
                            <td <?php if ($acessos['EMAIL_GESTOR_APOIO_SEDE'] == "01010101" or $rows_dados['EMAIL_GESTOR_APOIO_SEDE'] == "") { echo ($campoV);} ?>><?php echo $rows_dados['EMAIL_GESTOR_APOIO_SEDE']; ?></td>
                            <td <?php if ($acessos['EMAIL_INICIO_ATIVIDADES'] == "01010101" or $rows_dados['EMAIL_INICIO_ATIVIDADES'] == "") { echo ($campoV);} ?>><?php echo $rows_dados['EMAIL_INICIO_ATIVIDADES']; ?></td>
                            <td <?php if ($acessos['EMAIL_BOAS_VINDAS'] == "01010101" or $rows_dados['EMAIL_BOAS_VINDAS'] == "") { echo ($campoV);} ?>><?php echo $rows_dados['EMAIL_BOAS_VINDAS']; ?></td>
                            <td <?php if ($acessos['ACESSOS'] == "01010101" or $rows_dados['ACESSOS'] == "") { echo ($campoV);} ?>><?php echo $rows_dados['ACESSOS']; ?></td>
