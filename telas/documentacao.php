                ...
                <tbody>
                    <?php while ($rows_dados = mysqli_fetch_assoc($resultado)) {  ?>
                        <tr>
                            ...
                            <td <?php if ($ctps['FORMULARIOS_ENVIADOS'] == "01010101" or $rows_dados['FORMULARIOS_ENVIADOS'] == "") { echo ($campoV);} ?>><?php echo $rows_dados['FORMULARIOS_ENVIADOS']; ?></td>
                            <td <?php if ($ctps['FORMULARIOS_RECEBIDOS'] == "01010101" or $rows_dados['FORMULARIOS_RECEBIDOS'] == "") { echo ($campoV);} ?>><?php echo $rows_dados['FORMULARIOS_RECEBIDOS']; ?></td>
                            <td <?php if ($ctps['DOCUMENTOS_FISICOS'] == "01010101" or $rows_dados['DOCUMENTOS_FISICOS'] == "") { echo ($campoV);} ?>><?php echo $rows_dados['DOCUMENTOS_FISICOS']; ?></td>
                            <td <?php if ($ctps['CTPS_RECEBIDA'] == "01010101" or $rows_dados['CTPS_RECEBIDA'] == "") { echo ($campoV);} ?>><?php echo $rows_dados['CTPS_RECEBIDA']; ?></td>
