            ...
            <table id='first-table'>
                ...
                <tbody>
                    <?php while ($rows_dados = mysqli_fetch_assoc($resultado)) {  ?>
                        <tr>
                            <td><?= $status['STATUS'] ?></td>
                            <td <?php if ($envio['AGENDAMENTO_EXAM_ADM'] == "0001-01-01" or $rows_dados['AGENDAMENTO_EXAM_ADM'] == "" or "01010101") { echo ($campoV);} ?>><?php echo $rows_dados['AGENDAMENTO_EXAM_ADM']; ?></td>
                            <td <?php if ($envio['ENVIO_FUNC_EXAME'] == "0001-01-01" or $rows_dados['ENVIO_FUNC_EXAME'] == "" or "01010101") { echo ($campoV);} ?>><?php echo $rows_dados['ENVIO_FUNC_EXAME']; ?></td>
                            <td <?php if ($envio['EMAIL_RECEBIDO_EXAM'] == "0001-01-01" or $rows_dados['EMAIL_RECEBIDO_EXAM'] == "" or "01010101") { echo ($campoV);} ?>><?php echo $rows_dados['EMAIL_RECEBIDO_EXAM']; ?></td>
