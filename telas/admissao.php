            ...
            <table id='first-table'>
                ...
                <tbody>
                    <?php while ($rows_dados = mysqli_fetch_assoc($resultado)) {  ?>
                        <tr>
                            <td><?= $status['STATUS'] ?></td>
                            <td <?php if ($doc['QUALIFIC_CADASTRAL_CEP'] == "01010101" or $rows_dados['QUALIFIC_CADASTRAL_CEP'] == "") { echo ($campoV);} ?>><?php echo $rows_dados['QUALIFIC_CADASTRAL_CEP']; ?></td>
                            <td <?php if ($doc['CAD_ADM_PLATAFORMA_ADM_DIMIN'] == "01010101" or $rows_dados['CAD_ADM_PLATAFORMA_ADM_DIMIN'] == "") { echo ($campoV);} ?>><?php echo $rows_dados['CAD_ADM_PLATAFORMA_ADM_DIMIN']; ?></td>
                            <td <?php if ($doc['DOC_RECEBIDO_PLATAFORMA_DOMIN_CBO'] == "01010101" or $rows_dados['DOC_RECEBIDO_PLATAFORMA_DOMIN_CBO'] == "") { echo ($campoV);} ?>><?php echo $rows_dados['DOC_RECEBIDO_PLATAFORMA_DOMIN_CBO']; ?></td>
                            <td <?php if ($doc['TERMO_PSI'] == "01010101" or $rows_dados['TERMO_PSI'] == "") { echo ($campoV);} ?>><?php echo $rows_dados['TERMO_PSI']; ?></td>
                            <td <?php if ($doc['INCLUI_ADM_PROV'] == "01010101" or $rows_dados['INCLUI_ADM_PROV'] == "") { echo ($campoV);} ?>><?php echo $rows_dados['INCLUI_ADM_PROV']; ?></td>
