            ...
            <table id='first-table'>
                ...
                <tbody>
                    <?php while ($rows_dados = mysqli_fetch_assoc($resultado)) {  ?>
                        <tr>
                            <td><?= $status['STATUS'] ?></td>
                            <td <?php if ($layoutBoasVindas['BOAS_VINDAS_INGR_AGENDADA'] == "0000-00-00") {
                                        echo ($campoV);
                                    } ?> <?php if ($rows_dados['BOAS_VINDAS_INGR_AGENDADA'] == "") {
                                                                                                                                    echo ($campoV);
                                                                                                                                } ?>><?php echo $rows_dados['BOAS_VINDAS_INGR_AGENDADA']; ?></td>
                            <td <?php if ($layoutBoasVindas['BOAS_VINDAS_INGR_REALIZADA'] == "0000-00-00") {
                                        echo ($campoV);
                                    } ?> <?php if ($rows_dados['BOAS_VINDAS_INGR_REALIZADA'] == "") {
                                                                                                                                        echo ($campoV);
                                                                                                                                    } ?>><?php echo $rows_dados['BOAS_VINDAS_INGR_REALIZADA']; ?></td>
                            <td <?php if ($rows_dados['BOAS_VINDAS_SALA'] == "") {
                                        echo ($campoV);
                                    } ?>><?php echo $rows_dados['BOAS_VINDAS_SALA']; ?></td>
                            <td <?php if ($layoutBoasVindas['LAYOUT_BOAS_VINDAS_MENSAL'] == "0000-00-00") {
                                        echo ($campoV);
