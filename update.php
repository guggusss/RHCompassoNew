<?php
	...
	function funcionario($conn, $USUARIO_ID, $ID_SEDE, $ID_TIPO, $ID_CAPTACAO, $CARGA_HORARIA, $HORARIO, $NOME, $SEXO, $FONE_CONTATO, $DATA_ADMISSAO, $CARGO, $SOLICITANTE, $LOG_REGISTRO_DIA_RH_ENVIA_DP, $REMUNERACAO_BASE, $GRATIFICACAO, $CLIENTE, $PROJETO, $EMAIL, $ADMINISTRATIVO, $POSICAO_DATA, $POSICAO_COMENTARIO,$COMENTARIOS) {
		$query = "UPDATE admissao_dominio set ID_SEDE = '{$ID_SEDE}', ID_TIPO = '{$ID_TIPO}', ID_CAPTACAO = '{$ID_CAPTACAO}', CARGA_HORARIA = '{$CARGA_HORARIA}', HORARIO = '{$HORARIO}', NOME = '{$NOME}', COMENTARIOS = '{$COMENTARIOS}', SEXO = '{$SEXO}', FONE_CONTATO = '{$FONE_CONTATO}', DATA_ADMISSAO = '{$DATA_ADMISSAO}', CARGO = '{$CARGO}', SOLICITANTE = '{$SOLICITANTE}', LOG_REGISTRO_DIA_RH_ENVIA_DP = '{$LOG_REGISTRO_DIA_RH_ENVIA_DP}', REMUNERACAO_BASE = '{$REMUNERACAO_BASE}', GRATIFICACAO = '{$GRATIFICACAO}', CLIENTE = '{$CLIENTE}', PROJETO = '{$PROJETO}', EMAIL='{$EMAIL}', ADMINISTRATIVO = '{$ADMINISTRATIVO}', POSICAO_DATA = '{$POSICAO_DATA}', POSICAO_COMENTARIO = '{$POSICAO_COMENTARIO}'  where USUARIO_ID = '{$USUARIO_ID}'";
		return mysqli_query($conn, $query);
	}
	...
	function Proposta($conn, $ID_USUARIO, $ENQUADRAMENTO_REMUNERACAO_ENVIO, $ENQUADRAMENTO_REMUNERACAO_RETORNO, $ENQUADRAMENTO, $ENVIO_PROPOSTA, $COMUNICAR_PROPOSTA_ENVIADA,$ACEITA_RECUSA_CANDIDATO, $COMENTARIOS, $COMUNICAR_STATUS){
		$query = "UPDATE propostas_contratacoes set ENQUADRAMENTO_REMUNERACAO_ENVIO = '{$ENQUADRAMENTO_REMUNERACAO_ENVIO}', ENQUADRAMENTO_REMUNERACAO_RETORNO = '{$ENQUADRAMENTO_REMUNERACAO_RETORNO}', ENQUADRAMENTO = '{$ENQUADRAMENTO}', ENVIO_PROPOSTA = '{$ENVIO_PROPOSTA}', COMUNICAR_PROPOSTA_ENVIADA = '{$COMUNICAR_PROPOSTA_ENVIADA}', ACEITE_RECUSA_CANDIDATO = '{$ACEITA_RECUSA_CANDIDATO}', COMENTARIOS = '{$COMENTARIOS}', COMUNICAR_STATUS = '{$COMUNICAR_STATUS}' where ID_USUARIO = '{$ID_USUARIO}'";
		return mysqli_query($conn, $query);
	}
