<?php
	...
	function exame($conn, $ID_USUARIO, $AGENDAMENTO_EXAM_ADM, $ENVIO_FUNC_EXAME, $EMAIL_RECEBIDO_EXAM){
		$query = "UPDATE exame_admissional set AGENDAMENTO_EXAM_ADM = '{$AGENDAMENTO_EXAM_ADM}', ENVIO_FUNC_EXAME='{$ENVIO_FUNC_EXAME}', EMAIL_RECEBIDO_EXAM = '{$EMAIL_RECEBIDO_EXAM}' where ID_USUARIO = '{$ID_USUARIO}'";
		return mysqli_query($conn, $query);
	}
