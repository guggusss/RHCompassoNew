...
CREATE TABLE if not exists `propostas_contratacoes` (
  ...
  `ENQUADRAMENTO_REMUNERACAO_ENVIO` VARCHAR(10) DEFAULT NULL,
  `ENQUADRAMENTO_REMUNERACAO_RETORNO` VARCHAR(10) DEFAULT NULL,
  `ENQUADRAMENTO` varchar(110) DEFAULT NULL,
  `ENVIO_PROPOSTA` VARCHAR(10) DEFAULT NULL,
  `COMUNICAR_PROPOSTA_ENVIADA`VARCHAR(10) DEFAULT NULL,
  `ACEITE_RECUSA_CANDIDATO`VARCHAR(10) DEFAULT NULL,
  `COMENTARIO` varchar(200) DEFAULT NULL,
  `COMUNICAR_STATUS`VARCHAR(10) DEFAULT NULL,
...
CREATE TABLE if not exists `documentacao` (
  ...
  `ID_USUARIO` int(11) not null,
  `FORMULARIOS_ENVIADOS`VARCHAR(10) DEFAULT NULL,
  `FORMULARIOS_RECEBIDOS`VARCHAR(10) DEFAULT NULL,
  `DOCUMENTOS_FISICOS`VARCHAR(10) DEFAULT NULL,
  `CTPS_RECEBIDA`VARCHAR(10) DEFAULT NULL,
  `COMENTARIO` varchar(200) DEFAULT NULL,
...
CREATE TABLE if not exists `admissao` (
  ...
  `ID_USUARIO` int(11) not null,
  `QUALIFIC_CADASTRAL_CEP`VARCHAR(10) DEFAULT NULL,
  `CAD_ADM_PLATAFORMA_ADM_DIMIN`VARCHAR(10) DEFAULT NULL,
  `DOC_RECEBIDO_PLATAFORMA_DOMIN_CBO`VARCHAR(10) DEFAULT NULL,
  `TERMO_PSI`VARCHAR(10) DEFAULT NULL,
  `INCLUI_ADM_PROV`VARCHAR(10) DEFAULT NULL,
  `COMENTARIO` varchar(200) DEFAULT NULL,
...
CREATE TABLE if not exists `exame_admissional` (
  ...
  `ID_USUARIO` int(11) not null,
  `AGENDAMENTO_EXAM_ADM`VARCHAR(10) DEFAULT NULL,
  `ENVIO_FUNC_EXAME`VARCHAR(10) DEFAULT NULL,
  `EMAIL_RECEBIDO_EXAM`VARCHAR(10) DEFAULT NULL,
  `COMENTARIO` varchar(200) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `bancorh`.`interno` (
  ...
  `ID_USUARIO` INT NOT NULL,
  `INTRANET_CADASTRO_USUARIO`VARCHAR(10)  DEFAULT NULL,
  `INTRANET_CADASTRO_SENHA` VARCHAR(30)  DEFAULT NULL,
  `KAIROS_CADASTRO_USUARIO`VARCHAR(10)  DEFAULT NULL,
  `KAIROS_CADASTRO_SENHA` VARCHAR(30)  DEFAULT NULL,
  `EMAIL_GESTOR_APOIO_SEDE` VARCHAR(45)  DEFAULT NULL,
  `EMAIL_INICIO_ATIVIDADES`VARCHAR(10)  DEFAULT NULL,
  `EMAIL_BOAS_VINDAS`VARCHAR(10)  DEFAULT NULL,
  `ACESSOS`VARCHAR(10) default null,
...
CREATE TABLE IF NOT EXISTS `bancorh`.`vias_documentos_funcionarios` (
  ...
  `SALVAR_PASTA` DATE  DEFAULT NULL,
